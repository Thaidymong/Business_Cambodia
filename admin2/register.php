...
<body>
    ...
    <div class="container bg-dark mt-2 p-4">
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="" class="text-white">Telephone</label>
                <input type="text" name="txt_tel" class="form-control" placeholder="+885">
            </div>
...
$sql  = "INSERT INTO `register`( `name`, `password`, `gender`, `email`, `telephone`)
            VALUES ('$name','$password','$gender','$email','$tel')";
$res  = $con->query($sql);

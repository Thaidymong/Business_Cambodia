...
<body class="body1">
    <div class="box">
        ...
        <div class="box-content-right">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Modal Insert</h5>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="txt_types_photo" class="form-control" id="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="btn-submit-photo" class="btn btn-success">Upload</button>
                                </div>
                            </form>
                        </div>
            ...
            <!-- Read data(table) -->
            <div class="w-50 text-white mt-4" style="margin-left: 350px;">
            <table id="example" class="table w-100 text-white" >
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Photos</th>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                <td><?= $index; ?></td>
                                <td><img style="width: 50px; height: 50px; border-radius: 50px" src="../upload/<?= $row['photo'] ?>"></td>
                                <td><?= $row['type'] ?></td>
                                <td>
                            ...
                            <!-- Modal Update-->
                            <div class="modal fade text-dark" id="ModalUpdate<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Modal Update</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                    <button type="submit" name="btn-update-photo" class="btn btn-primary">Update</button>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="btn-delete-photo" class="btn btn-danger">Delete</button>
                                                </div>
                                            </form>
                                        </div>
